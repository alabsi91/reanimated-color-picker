(self.webpackChunkmy_docs = self.webpackChunkmy_docs || []).push([
  [349],
  {
    ...
    804: (e, t, n) => {
      ...
      const j = { codeBlockContainer: 'codeBlockContainer_Ckt0' };
      var N = n(5893);
      function C(e) {
        let { as: t, ...n } = e;
        const s = (function (e) {
        ...
        return (0, N.jsx)(t, { ...n, style: s, className: (0, i.Z)(n.className, j.codeBlockContainer, d.k.common.codeBlock) });
      }
      const k = {
      ...
      function L(e) {
        ...
        return (0, N.jsx)(C, {
          as: 'pre',
          tabIndex: 0,
          className: (0, i.Z)(k.codeBlockStandalone, 'thin-scrollbar', n),
          children: (0, N.jsx)('code', { className: k.codeBlockLines, children: t }),
        });
      }
      var y = n(902);
      const _ = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
      function B(e, t) {
      ...
      var Z = n(2573);
      const w = { codeLine: 'codeLine_lJS_', codeLineNumber: 'codeLineNumber_Tfdd', codeLineContent: 'codeLineContent_feaV' };
      function T(e) {
        let { line: t, classNames: n, showLineNumbers: s, getLineProps: a, getTokenProps: o } = e;
        1 === t.length && '\n' === t[0].content && (t[0].content = '');
        const l = a({ line: t, className: (0, i.Z)(n, s && w.codeLine) }),
          c = t.map((e, t) => (0, N.jsx)('span', { ...o({ token: e, key: t }) }, t));
        return (0, N.jsxs)('span', {
          ...
          children: [
            s
              ? (0, N.jsxs)(N.Fragment, {
                  children: [
                    (0, N.jsx)('span', { className: w.codeLineNumber }),
                    (0, N.jsx)('span', { className: w.codeLineContent, children: c }),
                  ],
                })
              : c,
            (0, N.jsx)('br', {}),
      ...
      function A(e) {
        return (0, N.jsx)('svg', {
          viewBox: '0 0 24 24',
          ...e,
          children: (0, N.jsx)('path', { fill: 'currentColor', d: 'M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z' }),
        });
      }
      const I = {
      ...
      function M(e) {
        ...
        return (
          ...
          (0, N.jsx)('button', {
            ...
            title: (0, E.I)({ id: 'theme.CodeBlock.copy', message: 'Copy', description: 'The copy button label on code blocks' }),
            className: (0, i.Z)('clean-btn', n, I.copyButton, a && I.copyButtonCopied),
            onClick: c,
            children: (0, N.jsxs)('span', {
              className: I.copyButtonIcons,
              'aria-hidden': 'true',
              children: [(0, N.jsx)(H, { className: I.copyButtonIcon }), (0, N.jsx)(A, { className: I.copyButtonSuccessIcon })],
            }),
          })
        );
      }
      ...
      const U = { wordWrapButtonIcon: 'wordWrapButtonIcon_Bwma', wordWrapButtonEnabled: 'wordWrapButtonEnabled_EoeP' };
      function z(e) {
        ...
        return (0, N.jsx)('button', {
          type: 'button',
          onClick: n,
          className: (0, i.Z)('clean-btn', t, s && U.wordWrapButtonEnabled),
          'aria-label': a,
          title: a,
          children: (0, N.jsx)(S, { className: U.wordWrapButtonIcon, 'aria-hidden': 'true' }),
        });
      }
      function V(e) {
        ...
        const {
          ...
          { lineClassNames: g, code: j } = v(t, { metastring: a, language: p, magicComments: m }),
          L =
            l ??
            (function (e) {
        ...
        return (0, N.jsxs)(C, {
          ...
          children: [
            b && (0, N.jsx)('div', { className: k.codeBlockTitle, children: b }),
            (0, N.jsxs)('div', {
                ...
                (0, N.jsx)(Z.y$, {
                  ...
                  children: e => {
                    ...
                    return (0, N.jsx)('pre', {
                      tabIndex: 0,
                      ref: x.codeBlockRef,
                      className: (0, i.Z)(t, k.codeBlock, 'thin-scrollbar'),
                      style: n,
                      children: (0, N.jsx)('code', {
                        className: (0, i.Z)(k.codeBlockLines, L && k.codeBlockLinesWithNumbering),
                        children: s.map((e, t) =>
                          (0, N.jsx)(T, { line: e, getLineProps: a, getTokenProps: o, classNames: g[t], showLineNumbers: L }, t),
                        ),
                      }),
                    });
                  },
                ...
                (0, N.jsxs)('div', {
                  ...
                  children: [
                    (x.isEnabled || x.isCodeScrollable) &&
                      (0, N.jsx)(z, { className: k.codeButton, onClick: () => x.toggle(), isEnabled: x.isEnabled }),
                    (0, N.jsx)(M, { className: k.codeButton, code: j }),
                  ],
                }),
              ],
            }),
      ...
      function R(e) {
        ...
        const a = (0, o.Z)(),
          ...
          l = 'string' == typeof i ? V : L;
        return (0, N.jsx)(l, { ...n, children: i }, String(a));
      }
      function O(e) {
      ...
      var P = n(3692);
      var $ = n(6043);
      const D = { details: 'details_lb9f', isBrowser: 'isBrowser_bmU9', collapsibleContent: 'collapsibleContent_i85q' };
      function W(e) {
        return !!e && ('SUMMARY' === e.tagName || W(e.parentElement));
      }
      function F(e, t) {
        return !!e && (e === t || F(e.parentElement, t));
      }
      function q(e) {
        let { summary: t, children: n, ...a } = e;
        const l = (0, o.Z)(),
          c = (0, s.useRef)(null),
          { collapsed: r, setCollapsed: d } = (0, $.u)({ initialState: !a.open }),
          [u, m] = (0, s.useState)(a.open),
          h = s.isValidElement(t) ? t : (0, N.jsx)('summary', { children: t ?? 'Details' });
        return (0, N.jsxs)('details', {
          ...a,
          ref: c,
          open: u,
          'data-collapsed': r,
          className: (0, i.Z)(D.details, l && D.isBrowser, a.className),
          onMouseDown: e => {
            W(e.target) && e.detail > 1 && e.preventDefault();
          },
          onClick: e => {
            e.stopPropagation();
            const t = e.target;
            W(t) && F(t, c.current) && (e.preventDefault(), r ? (d(!1), m(!0)) : d(!0));
          },
          children: [
            h,
            (0, N.jsx)($.z, {
              ...
              children: (0, N.jsx)('div', { className: D.collapsibleContent, children: n }),
            }),
          ],
        });
      }
      const G = { details: 'details_b_Ee' },
        J = 'alert alert--info';
      function Y(e) {
        let { ...t } = e;
        return (0, N.jsx)(q, { ...t, className: (0, i.Z)(J, G.details, t.className) });
      }
      function Q(e) {
        const t = s.Children.toArray(e.children),
          n = t.find(e => s.isValidElement(e) && 'summary' === e.type),
          a = (0, N.jsx)(N.Fragment, { children: t.filter(e => e !== n) });
        return (0, N.jsx)(Y, { ...e, summary: n, children: a });
      }
      var X = n(2503);
      function K(e) {
        return (0, N.jsx)(X.Z, { ...e });
      }
      const ee = { containsTaskList: 'containsTaskList_mC6p' };
      function te(e) {
        if (void 0 !== e) return (0, i.Z)(e, e?.includes('contains-task-list') && ee.containsTaskList);
      }
      const ne = { img: 'img_ev3q' };
      var se = n(9047),
        ae = n(1875);
      const oe = {
        Head: a.Z,
        ...
        ul: function (e) {
          return (0, N.jsx)('ul', { ...e, className: te(e.className) });
        },
        img: function (e) {
          return (0, N.jsx)('img', { loading: 'lazy', ...e, className: ((t = e.className), (0, i.Z)(t, ne.img)) });
          var t;
        },
        h1: e => (0, N.jsx)(K, { as: 'h1', ...e }),
        h2: e => (0, N.jsx)(K, { as: 'h2', ...e }),
        h3: e => (0, N.jsx)(K, { as: 'h3', ...e }),
        h4: e => (0, N.jsx)(K, { as: 'h4', ...e }),
        h5: e => (0, N.jsx)(K, { as: 'h5', ...e }),
        h6: e => (0, N.jsx)(K, { as: 'h6', ...e }),
        admonition: se.Z,
        mermaid: ae.Z,
      };
    },
