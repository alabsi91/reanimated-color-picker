  ...
  [943],
  {
    1087: (e, n, i) => {
      ...
      var l = i(5893),
        t = i(1151),
        d = i(51);
      const r = { sidebar_position: 6, sidebar_label: 'RedSlider', description: "A slider to change the color's red channel." },
        s = '<RedSlider />',
        h = {
          id: 'API/Sliders/RGB/RedSlider',
          title: '<RedSlider />',
          description: "A slider to change the color's red channel.",
          source: '@site/docs/API/Sliders/RGB/RedSlider.mdx',
          sourceDirName: 'API/Sliders/RGB',
          slug: '/API/Sliders/RGB/RedSlider',
          permalink: '/reanimated-color-picker/docs/API/Sliders/RGB/RedSlider',
          draft: !1,
          unlisted: !1,
          tags: [],
          version: 'current',
          ...
          previous: { title: 'RGB', permalink: '/reanimated-color-picker/docs/category/rgb' },
          next: { title: 'GreenSlider', permalink: '/reanimated-color-picker/docs/API/Sliders/RGB/GreenSlider' },
        },
        c = {},
        o = [
        ...
        return (
          (n = e.disableParentContext
            ? 'function' == typeof e.components
              ...
              : e.components || t
            : r(e.components)),
          l.createElement(d.Provider, { value: n }, e.children)
        );
      }
    },
  },
