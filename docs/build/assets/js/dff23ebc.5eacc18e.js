  ...
  [110],
  {
    9615: (e, n, i) => {
      ...
      var t = i(5893),
        l = i(1151),
        r = i(51);
      const d = { sidebar_position: 5, sidebar_label: 'OpacitySlider', description: "A slider to change the color's opacity." },
        s = '<OpacitySlider />',
        h = {
        ...
        c = {},
        o = [
          { value: 'A slider to change the color&#39;s opacity.', id: 'a-slider-to-change-the-colors-opacity', level: 3 },
      ...
      function a(e) {
        ...
        return (0, t.jsxs)(t.Fragment, {
          children: [
            (0, t.jsx)(n.h1, { id: 'opacityslider-', children: (0, t.jsx)(n.code, { children: '<OpacitySlider />' }) }),
            '\n',
            (0, t.jsx)(n.p, { children: (0, t.jsx)(n.img, { alt: 'opacity', src: i(5048).Z + '', width: '256', height: '40' }) }),
            '\n',
            (0, t.jsxs)(n.ul, {
              children: [
                '\n',
                (0, t.jsxs)(n.li, {
                  children: [
                    '\n',
                    (0, t.jsx)(n.h3, {
                      id: 'a-slider-to-change-the-colors-opacity',
                      children: "A slider to change the color's opacity.",
                    }),
                    '\n',
                  ],
                }),
      ...
      function d(e) {
        ...
        return (0, t.jsxs)(t.Fragment, {
          children: [
            ...
            '\n',
            (0, t.jsx)(n.p, {
              children: (0, t.jsx)(n.img, { alt: 'boundedThumb', src: i(9248).Z + '', width: '180', height: '130' }),
            }),
            '\n',
            (0, t.jsxs)(n.ul, {
              children: [
