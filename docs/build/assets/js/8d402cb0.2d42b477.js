  ...
  [529],
  {
    7757: (e, n, i) => {
      ...
      const s = {
        ...
        d = '<HSLSaturationSlider />',
        c = {
          id: 'API/Sliders/HSL/HSLSaturationSlider',
          title: '<HSLSaturationSlider />',
          description: 'A slider for adjusting the color saturation channel in the HSL color space.',
          source: '@site/docs/API/Sliders/HSL/HSLSaturationSlider.mdx',
          sourceDirName: 'API/Sliders/HSL',
          slug: '/API/Sliders/HSL/HSLSaturationSlider',
          ...
          previous: { title: 'HSL', permalink: '/reanimated-color-picker/docs/category/hsl' },
          next: { title: 'LuminanceSlider', permalink: '/reanimated-color-picker/docs/API/Sliders/HSL/LuminanceSlider' },
        },
        h = {},
        o = [
          {
            value: 'A slider for adjusting the color saturation channel in the HSL color space.',
            id: 'a-slider-for-adjusting-the-color-saturation-channel-in-the-hsl-color-space',
            level: 3,
          },
      ...
      function a(e) {
        ...
        return (0, t.jsxs)(t.Fragment, {
          children: [
            (0, t.jsx)(n.h1, {
              id: 'hslsaturationslider-',
              children: (0, t.jsx)(n.code, { children: '<HSLSaturationSlider />' }),
            }),
            '\n',
            (0, t.jsx)(n.p, {
              children: (0, t.jsx)(n.img, { alt: 'hsl_saturation', src: i(6574).Z + '', width: '256', height: '40' }),
            }),
            '\n',
            (0, t.jsxs)(n.ul, {
              children: [
                ...
                (0, t.jsxs)(n.li, {
                  children: [
                    ...
                    (0, t.jsx)(n.h3, {
                      id: 'a-slider-for-adjusting-the-color-saturation-channel-in-the-hsl-color-space',
                      children: 'A slider for adjusting the color saturation channel in the HSL color space.',
                    }),
                    '\n',
                  ],
                }),
    ...
    6574: (e, n, i) => {
      i.d(n, { Z: () => t });
      const t = i.p + 'assets/images/hsl_saturation-640380a560465175a49e9a4f74d54f0a.png';
    },
    1151: (e, n, i) => {
      i.d(n, { Z: () => d, a: () => s });
      var t = i(7294);
