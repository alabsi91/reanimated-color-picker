  ...
  [390],
  {
    4108: (e, n, l) => {
      ...
      const d = { sidebar_position: 8, sidebar_label: 'BlueSlider', description: "A slider to change the color's blue channel." },
        s = '<BlueSlider />',
        c = {
          id: 'API/Sliders/RGB/BlueSlider',
          title: '<BlueSlider />',
          description: "A slider to change the color's blue channel.",
          source: '@site/docs/API/Sliders/RGB/BlueSlider.mdx',
          sourceDirName: 'API/Sliders/RGB',
          slug: '/API/Sliders/RGB/BlueSlider',
          permalink: '/reanimated-color-picker/docs/API/Sliders/RGB/BlueSlider',
          draft: !1,
          unlisted: !1,
          tags: [],
          version: 'current',
          ...
          previous: { title: 'GreenSlider', permalink: '/reanimated-color-picker/docs/API/Sliders/RGB/GreenSlider' },
          next: { title: 'OpacitySlider', permalink: '/reanimated-color-picker/docs/API/Sliders/OpacitySlider' },
        },
        h = {},
        o = [
          {
      ...
      function j(e) {
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            (0, i.jsx)(n.h1, { id: 'blueslider-', children: (0, i.jsx)(n.code, { children: '<BlueSlider />' }) }),
            '\n',
