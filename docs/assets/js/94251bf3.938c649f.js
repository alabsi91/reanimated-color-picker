  ...
  [181],
  {
      ...
      var d = r.createContext({}),
        ...
        s = r.forwardRef(function (e, t) {
          var n = e.components,
            ...
            m = p(n),
            s = i,
            c = m[''.concat(d, '.').concat(s)] || m[s] || u[s] || a;
          return n ? r.createElement(c, l(l({ ref: t }, h), {}, { components: n })) : r.createElement(c, l({ ref: t }, h));
        });
      function c(e, t) {
        var n = arguments,
          i = t && t.mdxType;
    ...
    1307: (e, t, n) => {
      ...
      var r = n(7462),
        i = (n(7294), n(3905)),
        a = n(2650);
      const l = { sidebar_position: 6, sidebar_label: 'RedSlider', description: "A slider to change the color's red channel." },
        o = '<RedSlider />',
        d = {
          unversionedId: 'API/RedSlider',
          id: 'API/RedSlider',
          title: '<RedSlider />',
        ...
        p = {},
        h = [{ value: 'Props', id: 'props', level: 2 }],
        m = { toc: h };
      function u(e) {
        ...
        return (0, i.kt)(
          ...
          (0, i.kt)('h1', { id: 'redslider-' }, (0, i.kt)('inlineCode', { parentName: 'h1' }, '<RedSlider />')),
          (0, i.kt)('p', null, (0, i.kt)('img', { alt: 'red', src: n(2901).Z, width: '256', height: '40' })),
          (0, i.kt)(
            'ul',
            null,
            (0, i.kt)(
              ...
              (0, i.kt)(
                'h3',
                { parentName: 'li', id: 'a-slider-to-change-the-colors-red-channel' },
                "A slider to change the color's red channel."
              )
            )
          ),
          (0, i.kt)('h2', { id: 'props' }, 'Props'),
          (0, i.kt)(a.ZP, { mdxType: 'SliderProps' })
        );
      }
      u.isMDXComponent = !0;
    },
    ...
    2650: (e, t, n) => {
      ...
      function o(e) {
        ...
        return (0, i.kt)(
          ...
          (0, i.kt)(a.ZP, { mdxType: 'RenderThumb' }),
