  ...
  [993],
  {
    3905: (e, t, n) => {
      ...
      var d = r.createContext({}),
        ...
        m = r.forwardRef(function (e, t) {
          var n = e.components,
            ...
            h = p(n),
            m = a,
            c = h[''.concat(d, '.').concat(m)] || h[m] || s[m] || l;
      ...
      function c(e, t) {
        ...
        if ('string' == typeof e || a) {
          ...
          (o.originalType = e), (o[h] = 'string' == typeof e ? e : a), (i[1] = o);
    ...
    4718: (e, t, n) => {
      ...
      var r = n(7462),
        a = (n(7294), n(3905)),
        l = n(2650);
      const i = { sidebar_position: 2, sidebar_label: 'HueSlider', description: "A slider to change the color's hue." },
        o = '<HueSlider />',
        d = {
          unversionedId: 'API/HueSlider',
          id: 'API/HueSlider',
          title: '<HueSlider />',
      ...
      function s(e) {
        ...
        return (0, a.kt)(
          'wrapper',
          (0, r.Z)({}, h, i, { components: t, mdxType: 'MDXLayout' }),
          (0, a.kt)('h1', { id: 'hueslider-' }, (0, a.kt)('inlineCode', { parentName: 'h1' }, '<HueSlider />')),
          (0, a.kt)('p', null, (0, a.kt)('img', { alt: 'hue', src: n(8870).Z, width: '256', height: '40' })),
          (0, a.kt)(
            'ul',
            null,
            (0, a.kt)(
              ...
              (0, a.kt)(
                'h3',
                { parentName: 'li', id: 'a-slider-to-change-the-colors-hue' },
          ...
          (0, a.kt)(l.ZP, { mdxType: 'SliderProps' })
        );
      }
      s.isMDXComponent = !0;
    },
    ...
    2650: (e, t, n) => {
      ...
      function o(e) {
        ...
        return (0, a.kt)(
          ...
          (0, a.kt)('h3', { id: 'boundedthumb' }, (0, a.kt)('inlineCode', { parentName: 'h3' }, 'boundedThumb')),
          (0, a.kt)('p', null, (0, a.kt)('img', { alt: 'boundedThumb', src: n(9248).Z, width: '180', height: '130' })),
          (0, a.kt)(
            'ul',
            null,
            (0, a.kt)(
            ...
            (0, a.kt)(
              ...
              { parentName: 'ul' },
              'When set to ',
              (0, a.kt)('inlineCode', { parentName: 'li' }, 'true'),
            ...
            (0, a.kt)(
              ...
              { parentName: 'ul' },
              'When set to ',
              (0, a.kt)('inlineCode', { parentName: 'li' }, 'false'),
          ...
          (0, a.kt)(
            ...
            (0, a.kt)(
              ...
              (0, a.kt)('inlineCode', { parentName: 'li' }, 'width'),
              ' of the slider in ',
              (0, a.kt)('inlineCode', { parentName: 'li' }, 'vertical'),
              ' mode or the ',
              (0, a.kt)('inlineCode', { parentName: 'li' }, 'height'),
              ' in ',
              (0, a.kt)('inlineCode', { parentName: 'li' }, 'horizontal'),
              ' mode.'
            ),
            (0, a.kt)('li', { parentName: 'ul' }, (0, a.kt)('inlineCode', { parentName: 'li' }, 'type: number')),
          ...
          (0, a.kt)(l.ZP, { mdxType: 'RenderThumb' }),
          (0, a.kt)('h3', { id: 'reverse' }, (0, a.kt)('inlineCode', { parentName: 'h3' }, 'reverse')),
          (0, a.kt)(
            'ul',
            null,
            (0, a.kt)('li', { parentName: 'ul' }, 'Reverse the slider direction.'),
            (0, a.kt)('li', { parentName: 'ul' }, (0, a.kt)('inlineCode', { parentName: 'li' }, 'type: boolean')),
            (0, a.kt)('li', { parentName: 'ul' }, (0, a.kt)('inlineCode', { parentName: 'li' }, 'default: false'))
          ),
          (0, a.kt)('h3', { id: 'vertical' }, (0, a.kt)('inlineCode', { parentName: 'h3' }, 'vertical')),
          (0, a.kt)(
            'ul',
            null,
            (0, a.kt)('li', { parentName: 'ul' }, 'Change the slider orientation.'),
            (0, a.kt)('li', { parentName: 'ul' }, (0, a.kt)('inlineCode', { parentName: 'li' }, 'type: boolean')),
            (0, a.kt)('li', { parentName: 'ul' }, (0, a.kt)('inlineCode', { parentName: 'li' }, 'default: false'))
          ),
