      ...
      function f() {
        const { shown: e, scrollToTop: t } = (function (e) {
          ...
          return (
            (0, b.RF)((e, n) => {
              let { scrollY: a } = e;
              const r = null == n ? void 0 : n.scrollY;
              r &&
                (o.current
                  ? (o.current = !1)
                  : a >= r
        ...
        return a.createElement('button', {
          ...
          className: (0, l.Z)('clean-btn', r.k.common.backToTopButton, h, e && E),
          type: 'button',
          onClick: t,
        });
      }
                ...
                (0, S.Z)(
                  {
                    ...
                    onClick: b
                      ? e => {
                          null == n || n(t), h ? Z(!1) : (e.preventDefault(), Z());
                        }
                      : () => {
                          null == n || n(t);
                        },
