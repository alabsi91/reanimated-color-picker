  ...
  [174],
  {
      ...
      var d = r.createContext({}),
        ...
        h = r.forwardRef(function (e, t) {
          var n = e.components,
            ...
            s = p(n),
            h = l,
            c = s[''.concat(d, '.').concat(h)] || s[h] || m[h] || a;
          return n ? r.createElement(c, i(i({ ref: t }, u), {}, { components: n })) : r.createElement(c, i({ ref: t }, u));
        });
      function c(e, t) {
        var n = arguments,
          l = t && t.mdxType;
        if ('string' == typeof e || l) {
          ...
          (o.originalType = e), (o[s] = 'string' == typeof e ? e : l), (i[1] = o);
    ...
    6543: (e, t, n) => {
      ...
      var r = n(7462),
        l = (n(7294), n(3905)),
        a = n(2650);
      const i = { sidebar_position: 8, sidebar_label: 'BlueSlider', description: "A slider to change the color's blue channel." },
        o = '<BlueSlider />',
        d = {
          unversionedId: 'API/BlueSlider',
          id: 'API/BlueSlider',
          title: '<BlueSlider />',
        ...
        p = {},
        u = [{ value: 'Props', id: 'props', level: 2 }],
        s = { toc: u };
      function m(e) {
        ...
        return (0, l.kt)(
          ...
          (0, l.kt)('h1', { id: 'blueslider-' }, (0, l.kt)('inlineCode', { parentName: 'h1' }, '<BlueSlider />')),
          (0, l.kt)('p', null, (0, l.kt)('img', { alt: 'blue', src: n(3640).Z, width: '256', height: '40' })),
          (0, l.kt)(
            'ul',
            null,
            (0, l.kt)(
              ...
              (0, l.kt)(
                'h3',
                { parentName: 'li', id: 'a-slider-to-change-the-colors-blue-channel' },
                "A slider to change the color's blue channel."
              )
            )
          ),
          (0, l.kt)('h2', { id: 'props' }, 'Props'),
          (0, l.kt)(a.ZP, { mdxType: 'SliderProps' })
        );
      }
      m.isMDXComponent = !0;
    },
    6862: (e, t, n) => {
      ...
      function i(e) {
        ...
        return (0, l.kt)(
          'wrapper',
          (0, r.Z)({}, a, n, { components: t, mdxType: 'MDXLayout' }),
    ...
    2650: (e, t, n) => {
      ...
      function o(e) {
        ...
        return (0, l.kt)(
          'wrapper',
          (0, r.Z)({}, i, o, { components: t, mdxType: 'MDXLayout' }),
          ...
          (0, l.kt)(a.ZP, { mdxType: 'RenderThumb' }),
