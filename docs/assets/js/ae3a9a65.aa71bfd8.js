  ...
  [656],
  {
      ...
      var d = r.createContext({}),
        ...
        m = r.forwardRef(function (e, t) {
          var n = e.components,
            ...
            u = p(n),
            m = l,
            c = u[''.concat(d, '.').concat(m)] || u[m] || h[m] || i;
          return n ? r.createElement(c, a(a({ ref: t }, s), {}, { components: n })) : r.createElement(c, a({ ref: t }, s));
        });
      function c(e, t) {
        var n = arguments,
          l = t && t.mdxType;
        if ('string' == typeof e || l) {
          ...
          (o.originalType = e), (o[u] = 'string' == typeof e ? e : l), (a[1] = o);
    ...
    8830: (e, t, n) => {
      ...
      const a = {
        ...
        o = '<BrightnessSlider />',
        d = {
          unversionedId: 'API/BrightnessSlider',
          id: 'API/BrightnessSlider',
          title: '<BrightnessSlider />',
          description: "A slider to change the color's brightness.",
          source: '@site/docs/API/BrightnessSlider.mdx',
          sourceDirName: 'API',
          slug: '/API/BrightnessSlider',
          permalink: '/reanimated-color-picker/docs/API/BrightnessSlider',
          draft: !1,
          tags: [],
          version: 'current',
          sidebarPosition: 3,
          ...
          previous: { title: 'HueSlider', permalink: '/reanimated-color-picker/docs/API/HueSlider' },
          next: { title: 'SaturationSlider', permalink: '/reanimated-color-picker/docs/API/SaturationSlider' },
        },
        p = {},
        s = [
      ...
      function h(e) {
        ...
        return (0, l.kt)(
          ...
          (0, l.kt)('h1', { id: 'brightnessslider-' }, (0, l.kt)('inlineCode', { parentName: 'h1' }, '<BrightnessSlider />')),
          (0, l.kt)('p', null, (0, l.kt)('img', { alt: 'brightness', src: n(1420).Z, width: '256', height: '40' })),
          (0, l.kt)(
            'ul',
            null,
            (0, l.kt)(
              ...
              (0, l.kt)(
                'h3',
                { parentName: 'li', id: 'a-slider-to-change-the-color-brightness' },
          ...
          (0, l.kt)(i.ZP, { mdxType: 'SliderProps' })
        );
      }
      h.isMDXComponent = !0;
    },
    ...
    2650: (e, t, n) => {
      ...
      function o(e) {
        ...
        return (0, l.kt)(
          'wrapper',
          (0, r.Z)({}, a, o, { components: t, mdxType: 'MDXLayout' }),
          ...
          (0, l.kt)(
            'ul',
            null,
            (0, l.kt)('li', { parentName: 'ul' }, "The size of the slider's thumb."),
          ...
          (0, l.kt)(
            'ul',
            null,
            (0, l.kt)('li', { parentName: 'ul' }, "The color of the slider's thumb."),
            (0, l.kt)('li', { parentName: 'ul' }, (0, l.kt)('inlineCode', { parentName: 'li' }, 'type: string')),
            (0, l.kt)('li', { parentName: 'ul' }, (0, l.kt)('inlineCode', { parentName: 'li' }, 'default: interactive*'))
          ),
          (0, l.kt)(
            'admonition',
            { type: 'info' },
            (0, l.kt)(
              ...
              (0, l.kt)('strong', { parentName: 'mdxAdmonitionTitle' }, '*', 'interactive')
            ),
            (0, l.kt)(
              'ul',
              { parentName: 'admonition' },
          ...
          (0, l.kt)(
            'ul',
            null,
            (0, l.kt)('li', { parentName: 'ul' }, "The shape and appearance of the slider's thumb."),
            (0, l.kt)('li', { parentName: 'ul' }, (0, l.kt)('inlineCode', { parentName: 'li' }, 'type: string')),
          ...
          (0, l.kt)(
            'ul',
            null,
            (0, l.kt)('li', { parentName: 'ul' }, "Thumb's containing View's style."),
          ...
          (0, l.kt)(
            'ul',
            null,
            (0, l.kt)('li', { parentName: 'ul' }, "Thumb's inner View(s) style."),
            (0, l.kt)('li', { parentName: 'ul' }, (0, l.kt)('inlineCode', { parentName: 'li' }, 'type: ViewStyle'))
          ),
          (0, l.kt)(i.ZP, { mdxType: 'RenderThumb' }),
          (0, l.kt)('h3', { id: 'reverse' }, (0, l.kt)('inlineCode', { parentName: 'h3' }, 'reverse')),
          (0, l.kt)(
            'ul',
            null,
            (0, l.kt)('li', { parentName: 'ul' }, 'Reverse the slider direction.'),
            (0, l.kt)('li', { parentName: 'ul' }, (0, l.kt)('inlineCode', { parentName: 'li' }, 'type: boolean')),
            (0, l.kt)('li', { parentName: 'ul' }, (0, l.kt)('inlineCode', { parentName: 'li' }, 'default: false'))
          ),
          (0, l.kt)('h3', { id: 'vertical' }, (0, l.kt)('inlineCode', { parentName: 'h3' }, 'vertical')),
          (0, l.kt)(
            'ul',
            null,
            (0, l.kt)('li', { parentName: 'ul' }, 'Change the slider orientation.'),
            (0, l.kt)('li', { parentName: 'ul' }, (0, l.kt)('inlineCode', { parentName: 'li' }, 'type: boolean')),
            (0, l.kt)('li', { parentName: 'ul' }, (0, l.kt)('inlineCode', { parentName: 'li' }, 'default: false'))
          ),
          ...
          (0, l.kt)(
            'ul',
            null,
            (0, l.kt)('li', { parentName: 'ul' }, "The style of the slider's container."),
            (0, l.kt)('li', { parentName: 'ul' }, (0, l.kt)('inlineCode', { parentName: 'li' }, 'type: ViewStyle'))
          ),
          (0, l.kt)(
            'admonition',
